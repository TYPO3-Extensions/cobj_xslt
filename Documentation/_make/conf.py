...
# TYPO3 extension sphinx on Sat, 27 Jul 2013 16:51:12 +0200.
#
...
# Example configuration for intersphinx: refer to the TYPO3 standard documentation.
intersphinx_mapping = {
    't3extbasebook': ('http://docs.typo3.org/typo3cms/ExtbaseFluidBook/', None),
    't3l10n':        ('http://docs.typo3.org/typo3cms/FrontendLocalizationGuide/', None),
    't3install':     ('http://docs.typo3.org/typo3cms/InstallationGuide/', None),
    't3maintenance': ('http://docs.typo3.org/typo3cms/MaintenanceGuide/', None),
    't3security':    ('http://docs.typo3.org/typo3cms/SecurityGuide/', None),
    't3cgl':         ('http://docs.typo3.org/typo3cms/CodingGuidelinesReference/', None),
    't3api':         ('http://docs.typo3.org/typo3cms/CoreApiReference/', None),
    't3fal':         ('http://docs.typo3.org/typo3cms/FileAbstractionLayerReference/', None),
    't3inside':      ('http://docs.typo3.org/typo3cms/InsideTypo3Reference/', None),
    't3skinning':    ('http://docs.typo3.org/typo3cms/SkinningReference/', None),
    't3tca':         ('http://docs.typo3.org/typo3cms/TCAReference/', None),
    't3tsconfig':    ('http://docs.typo3.org/typo3cms/TSconfigReference/', None),
    't3tsref':       ('http://docs.typo3.org/typo3cms/TyposcriptReference/', None),
    't3tssyntax':    ('http://docs.typo3.org/typo3cms/TyposcriptSyntaxReference/', None),
    't3services':    ('http://docs.typo3.org/typo3cms/Typo3ServicesReference/', None),
    't3editors':     ('http://docs.typo3.org/typo3cms/EditorsTutorial/', None),
    't3start':       ('http://docs.typo3.org/typo3cms/GettingStartedTutorial/', None),
    't3templating':  ('http://docs.typo3.org/typo3cms/TemplatingTutorial/', None),
    't3ts45':        ('http://docs.typo3.org/typo3cms/TyposcriptIn45MinutesTutorial/', None)
}
